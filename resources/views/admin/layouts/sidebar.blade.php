    ...
    <div class="d-flex align-items-center logo_nav">
        ...
        <a class="navbar-brand" href="/">
            <div class="d-flex align-items-center ">
                <img class="me-2" src="/frontend/assets/images/logo.png" alt="" width="55" />
            </div>
        </a>
    </div>
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li>
                    <a class="nav-link {{ request()->is('blogs') ? 'active' : '' }} ? 'active' : '' }}"
                        href="{{ route('blogs') }}" role="button">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span class="bi-patch-question"></span>
                            </span>
    ...
    <div class="d-flex align-items-center">
        ...
        <a class="navbar-brand" href="/">
            <div class="d-flex align-items-center py-3">
                <img class="me-2" src="/frontend/assets/images/logo.png" alt=""
                    width="55" />
            </div>
        </a>
    </div>
    ...
    <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
        ...
        <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard') }}">
            <div class="d-flex align-items-center"><img class="me-2"
                    src="/frontend/assets/images/logo.png" alt="" width="50" /><span

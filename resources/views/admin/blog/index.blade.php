...
<div class="card mt-2">
    <div class="card-header">
        <h5 class="pull-left pt-2">Blog</h5>
            <a href="{{route('add_blog')}}" class="btn btn-primary pull-right"><i class="bi bi-plus"></i> Add Blog</a>
        <div class="clear"></div>
    </div>
    <div id="tableExample">
            ...
            <table class="table mb-0 data-table fs-10 tableToExport">
                <thead class="bg-200">
                    <tr>
                        ...
                        <th class="text-900 sort text-nowrap">Title</th>
                ...
                <tbody id="business_filter_data">
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="{{route('edit_blog_action', $value->blog_id)}}" class="badge bg-info rounded rounded-circle" style="padding-top: 7px; padding-bottom: 7px;">
                                <i class="bi bi-pencil fs-9"></i>
                            </a>
                            <a href="{{route('delete_blog_action', $value->blog_id)}}" class="badge bg-danger rounded rounded-circle" style="padding-top: 7px; padding-bottom: 7px;"
